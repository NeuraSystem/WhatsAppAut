...
class LangChainEmbeddingAdapter {
    ...
    async generate(texts) {
        try {
            ...
            logger.error('Error en LangChainEmbeddingAdapter (index_intentions):', error);
            throw error;
        }
    }
}
...
async function indexIntentions() {
    try {
        ...
        logger.info(`Preparados ${documents.length} documentos de intención para indexación.`);
        ...
        logger.info(`Indexación completada. ${documents.length} intenciones añadidas/actualizadas en la colección '${INTENTIONS_COLLECTION_NAME}'.`);
