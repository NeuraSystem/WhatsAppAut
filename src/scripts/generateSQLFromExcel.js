...
class SQLGenerator {
    ...
    parseSheetData(rows, brand) {
        ...
        console.log(`   📋 Formato detectado: [Modelo, Precio, Calidad] sin headers`);
    ...
    looksLikeHeader(row) {
        ...
        return firstCell.includes('modelo') || 
    ...
    detectColumns(headers) {
        ...
        headers.forEach((header, index) => {
            ...
            else if (h.includes('precio') || h.includes('price') || h.includes('costo')) {
                map.precio = index;
            }
            else if (h.includes('nota') || h.includes('note') || h.includes('observ')) {
                map.notas = index;
            }
        });
